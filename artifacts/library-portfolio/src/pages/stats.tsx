...
export default function Stats() {
  ...
  return (
    <div className="space-y-10">
      ...
      {/* Books added per month — full width */}
          ...
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={stats.booksPerMonth} margin={{ top: 4, right: 4, left: -24, bottom: 0 }}>
                ...
                <RechartsTooltip
                  cursor={{ stroke: PRIMARY, strokeWidth: 1, strokeDasharray: "4 2" }}
                  contentStyle={tooltipStyle}
                  formatter={(v) => [`${v} book${v === 1 ? "" : "s"}`, "Added"]}
                />
              ...
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={ratingData} margin={{ top: 4, right: 4, left: -24, bottom: 0 }}>
                  ...
                  <RechartsTooltip
                    ...
                    contentStyle={tooltipStyle}
                    formatter={(v, _, props) => [`${v} book${v === 1 ? "" : "s"}`, `${props.payload.rating} star${props.payload.rating === 1 ? "" : "s"}`]}
                  />
      ...
      {/* 3-col row: Status + Language + Format */}
