...
import { useCreateBook, getListBooksQueryKey, getListRecentBooksQueryKey, getGetStatsQueryKey } from "@workspace/api-client-react";
    ...
    createBook.mutate({ data }, {
      onSuccess: (newBook) => {
        ...
        toast({ 
          ...
          description: `"${newBook.title}" has been cataloged.` 
        });
      ...
      onError: (err) => {
        toast({
          title: "Error",
          description: "Failed to add book. Please check your inputs.",
          variant: "destructive"
        });
      }
    });
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <FormField control={form.control} name="title" render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl><Input placeholder="e.g. The Secret History" className="bg-background" {...field} /></FormControl>
                    <FormMessage />
                  </FormItem>
                )} />
                <FormField control={form.control} name="author" render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl><Input placeholder="e.g. Donna Tartt" className="bg-background" {...field} /></FormControl>
                    <FormMessage />
                  </FormItem>
                )} />
              </div>
              ...
              <FormField control={form.control} name="coverUrl" render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>A direct link to an image of the book cover</FormDescription>
                  <FormMessage />
                </FormItem>
              )} />
            </div>
            ...
            <div className="space-y-6 pt-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-end">
                <FormField control={form.control} name="rating" render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl><Input type="number" min={0} max={5} className="bg-background w-32" {...field} value={field.value || ""} /></FormControl>
                    <FormMessage />
                  </FormItem>
                )} />
                ...
                <FormField control={form.control} name="isFavorite" render={({ field }) => (
                  <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-xl border p-4 bg-background">
                    <FormControl>
                      <Checkbox checked={field.value} onCheckedChange={field.onChange} className="data-[state=checked]:bg-primary data-[state=checked]:border-primary" />
                    </FormControl>
                    <div className="space-y-1 leading-none">
              ...
              <FormField control={form.control} name="review" render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea placeholder="What did you think of it?" className="min-h-[120px] bg-background resize-y" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )} />
              ...
              <FormField control={form.control} name="quotes" render={({ field }) => (
                <FormItem>
                  <FormLabel>Favorite Quotes (one per line)</FormLabel>
                  <FormControl>
                    <Textarea placeholder={"Quote 1\nQuote 2"} className="min-h-[120px] bg-background resize-y" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )} />
            ...
            <div className="space-y-6 pt-6">
              ...
              <FormField control={form.control} name="summary" render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea placeholder="Book description..." className="bg-background min-h-[100px]" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )} />
            ...
            <div className="pt-6 border-t flex justify-end">
              <Button type="button" variant="ghost" onClick={() => setLocation("/library")} className="mr-4">
                Cancel
              </Button>
